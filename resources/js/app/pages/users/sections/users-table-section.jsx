import { EyeDropperIcon, PencilIcon, PencilSquareIcon, TrashIcon } from '@heroicons/react/24/outline'
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <div>
                    <div className="flex items-center gap-x-3">
                        <h2 className="text-lg font-medium text-gray-800 dark:text-white">Users Table</h2>
                    </div>
                </div>
