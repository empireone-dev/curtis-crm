...
import { get_tickets_warehouse_thunk } from "../redux/warehouse-tickets-thunk";

export default function WarehouseExportTickets({ account }) {
    ...
    async function export_ticket() {
        setLoading(true);
        try {
            const exist = await store.dispatch(
                get_tickets_warehouse_thunk(account.country)
            );
