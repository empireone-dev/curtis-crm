            ...
            <section className="px-4 py-12 mx-auto bg-white">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex items-center mt-4 gap-x-3">
                        <Link
                            href={"/administrator/email_template/create"}
                                ...
                                <table className="min-w-full divide-y divide-gray-200">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th
                                                scope="col"
                                                className="px-12 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500  justify-center items-center"
                                            >
                                                Name
                                            </th>
                                            <th
                                                scope="col"
                                                className="px-12 py-3.5 text-sm font-normal text-right rtl:text-right text-gray-500  justify-center items-center"
                                            >
                                                Action
                                            </th>
                                        </tr>
