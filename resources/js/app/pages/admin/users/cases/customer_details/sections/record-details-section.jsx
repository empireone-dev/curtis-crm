        ...
        <div>
            <div>
                ...
                <div class="md:col-span-5">
                    ...
                    <input type="text" class="h-10 border mt-1 mb-2 rounded px-4 w-full bg-gray-50" value="" />
                </div>
                ...
                <div class="md:col-span-5">
                    ...
                    <textarea class="h-20 border mt-1 mb-2 rounded px-4 w-full bg-gray-50" value=""></textarea>
                </div>
            </div>
        </div>
    )
