...
const CustomerTicketsReadableSerialSection = () => {
    ...
    const handleClick = () => {
        document.getElementById('hidden-input4').click();
    };
                ...
                <ImageView
                    ...
                    >
                        <article className="group w-full h-full rounded-md focus:outline-none focus:shadow-outline relative  cursor-pointer text-transparent hover:text-white shadow-sm">
                            ...
                            <header
                                className={`${filesData?.readable_serial_section?'border-gray-400':'border-red-600'} border-dashed border-2  flex flex-col justify-center items-center`}>
