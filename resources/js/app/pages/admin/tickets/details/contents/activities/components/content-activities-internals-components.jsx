...
export default function ContentActivitiesInternalsComponents({ data }) {
    ...
    return (
        <div>
            <button
                ...
                className={`bg-violet-500  hover:bg-violet-600 p-3 rounded-md text-white`}
            >
                {data.type}
            </button>
            <Modal
            ...
            >
                <div className="flex flex-col w-full my-4">
                    <div className="flex gap-3 items-center justify-between my-3">
                        <div className="font-black">
                            TICKET INFORMATION
                            <div
                                className={`text-violet-500 border rounded-md border-violet-500 items-center justify-center flex`}
                            >
                                {data.type}
                            </div>
                        </div>
                ...
                <div className="flex flex-col w-full ">
                    ...
                    <div className="flex gap-2">
                        Warranty Status:
                        <div className="font-bold border border-violet-500 px-2 rounded-md">
                    ...
                    <div className="flex gap-2 my-2">
                        ...
                        {JSON.parse(result.issue).map((res) => {
                            return (
                                <div className="font-bold border border-violet-500 px-2 rounded-md mx-2">
                                    {res}
                                </div>
                            );
                        })}
