...
import { get_decision_making_by_ticket_id, store_decision_making_service } from '@/app/services/desicion-making-service';
    ...
    async function get_fedex_rate() {
        ...
        try {
            ...
            setData({
                ...
                estimated_cost: `${(parseFloat(result.rates.FEDEX_GROUND.PAYOR_ACCOUNT_PACKAGE) + parseFloat(data.cost_of_unit ?? '0')).toFixed(2)}`
            })
        } catch (error) {
        ...
        <form>
                            ...
                            <div
                                ...
                                <div className="flex gap-3 w-full">
                                    ...
                                    <Input
                                        ...
                                        name="after_discount"
                                        required={false}
                                        value={String(parseFloat(data?.retailers_price) - parseFloat(data?.discount ?? '0'))}
                                ...
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <Input
                                            ...
                                            span="$"
                                            required={false}
                                            value={String(data?.shipping_cost) ?? '0'}
                                            label="Shipping Cost"
                                            type="number"
                                        ...
                                        <Input
                                            ...
                                            span="$"
                                            required={false}
                                            value={String(data?.estimated_cost) ?? '0'}
            ...
            <div className='flex gap-5 my-12'>
                ...
                <div class="flex items-center">
                    <input checked={data.ticket_type == 'REPLACEMENT'} id="default-radio-2"
                        onChange={(e) => setData({
                            ...data,
                            ticket_type: e.target.value
                        })}
                        type="radio" value="REPLACEMENT" name="ticket_type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
                    <label htmlFor="default-radio-2" class="ms-2 text-xl font-medium text-gray-900">Replacement</label>
                </div>
                <div class="flex items-center">
                    <input checked={data.ticket_type == 'REFUND'} id="default-radio-3"
                        onChange={(e) => setData({
                            ...data,
                            ticket_type: e.target.value
                        })}
                        type="radio" value="REFUND" name="ticket_type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
                    <label htmlFor="default-radio-3" class="ms-2 text-xl font-medium text-gray-900">Refund</label>
                </div>
                <div class="flex items-center ">
                    <input checked={data.ticket_type == 'REPAIR'} id="default-radio-1"
                        onChange={(e) => setData({
                            ...data,
                            ticket_type: e.target.value
                        })}
                        type="radio" value="REPAIR" name="ticket_type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 " />
                    <label htmlFor="default-radio-1" class="ms-2 text-xl font-medium text-gray-900">Repair</label>
                </div>
            </div>
            ...
            <button
                ...
                {
                    isLoading1 ? <div className='p-1.5 flex items-center justify-center'>
                        <Loading />
