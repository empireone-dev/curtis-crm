...
import { get_tickets_by_ticket_id, update_tickets_by_user_id } from '@/app/services/tickets-service'
  ...
  async function close_ticket() {
    if (confirm('Are you sure you want to close the ticket?')) {
      ...
      try {
        ...
        setIsLoading(false)
        router.visit(`/administrator/tickets/details/${ticket.id}#files`);
      } catch (error) {
        setIsLoading(false)
      }
    }
      ...
      <div className="flex flex-col gap-4 mb-3">
        ...
        <div className='flex gap-4 items-center justify-center'>
          ...
          <button
            ...
            {isLoading ? <div className='py-1.5'>
              <Loading />
            </div> : 'Closed'}
          </button>
        </div>
