...
export default function AvailabilitySection() {
    ...
    async function submitButton(value) {
        setIsLoading(true);
        const status =
            value == "WILLING TO BUY"
                ? "CALLBACK"
                : value == "NOT WILLING TO BUY" || value == "CLOSE"
                ? "CLOSED"
                : value == "PENDING"
                ? "AVAILABILITY"
            ...
            <section className="container bg-white px-3">
                <form className="flex flex-col gap-6">
                    ...
                    <p>
                        ...
                        <Notes:div className="text-red-500">
                            {" "}
                            {ticket.availability_notes}
                        </Notes:div>
                    </p>
                    <p>
                        Internal Notes:
                        ...
                        <div className="flex gap-2 mt-10 py-6">
                            {ticket.warranty_status == "OOW" && (
                                <>
                                    <button
                                        onClick={() =>
                                            submitButton("WILLING TO BUY")
                                        }
                                        type="button"
                                        className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-green-500 rounded-sm hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-200 "
                                    >
                                        OOW &gt; WILLING TO BUY
                                    </button>
                                    <button
                                        onClick={() =>
                                            submitButton("NOT WILLING TO BUY")
                                        }
                                        type="button"
                                        className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-red-500 rounded-sm hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 "
                                    >
                            ...
                            {ticket.warranty_status == "IW" && (
                                <button
                                    ...
                                    type="button"
                                    className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-500 rounded-sm hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 "
                                >
                                    CLOSE
                                </button>
                            )}
                            ...
                            {isLoading && (
                                <div className="bg-orange-500 p-2 rounded-md text-white font-black flex gap-3 items-center justify-center">
                                    LOADING
                                    <Loading />
                                </div>
                            )}
