...
export default function ContentActivitiesTimelineSection() {
    ...
    console.log('className', activities)
    return (
                        ...
                        return (
                            <li key={i} className="mb-10 ms-6">
                                ...
                                <p className="mb-4 text-base font-normal text-gray-900">
                                    Agent Notes: {res.message}
                                </p>
                            </li>
                        );
                        break;
                    case "AI TICKET CREATED":
                        // const results = JSON.parse(res.message);
                        return (
                            <li key={i} className="mb-10 ms-6">
                                <UserCircleIcon className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white" />
                    ...
                    case "upload":
                        ...
                        return (
                            <li key={i} className="mb-10 ms-6">
                                <UserCircleIcon className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white" />
                                <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900">
                                    {res?.user_id == 0 ? 'Customer' : `#${res?.user?.id}`}
                                    <span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded ms-3">
                                        {formattedTimestamp}
                                    </span>
                                </h3>
                                ...
                                <p className="mb-4 text-base font-normal text-gray-900">
                                    {`${res?.user_id == 0 ? 'Customer' : `${res?.user?.emp_id}`} uploaded lacking information.` ?? "Customer uploaded lacking information."}
                                </p>
                            </li>
                        );
                        break;
                    case "SENT LACKING INFORMATION":
                        // const results = JSON.parse(res.message);
                        return (
                            <li key={i} className="mb-10 ms-6">
                                <UserCircleIcon className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white" />
                        ...
                        return (
                            ...
                            >
                                ...
                                <time className="block mb-2 text-sm font-normal leading-none text-gray-600">
                                    Closed By: {res?.user?.name}
                                </time>
                                <div className="text-2xl">{res.message}</div>
                            </li>
                        );
                        break;
