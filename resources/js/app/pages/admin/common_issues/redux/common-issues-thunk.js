...
import { delete_common_issues_service, get_common_issues_service, store_common_issues_service, update_common_issues_service } from '@/app/services/common-issue-services';

export function store_common_issues_thunk(data) {
  return async function (dispatch, getState) {
    const result = await store_common_issues_service(data)
    dispatch(commonIssuesSlice.actions.setCommonIssues(result.data));
    dispatch(commonIssuesSlice.actions.setCommonIssuesForm({}));
  };
}
