...
import AgentHandledCasesPaginationSection from "./sections/agent-handled-cases-pagination-section";
        ...
        <AgentLayout account={account}>
            <div className="p-3 flex gap-5 flex-col justify-between w-full h-full">
                        ...
                        <div className="overflow-auto h-full">
                            ...
                            {/* <Collapse
                                ...
                                items={tickets?.map((res, i) => ({
                                    ...
                                    children: res?.emails.map(
                                        (res) => {
                                            return (
                                                <AgentHandledCasesListSection
                                                    data={res}
                                                />
                                            );
                                        }
                ...
                <div className="flex items-center justify-end">
                    <AgentHandledCasesPaginationSection />
                </div>
            </div>
        </AgentLayout>
    );
