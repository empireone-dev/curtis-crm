...
import { BriefcaseIcon, ClipboardDocumentIcon, CloudArrowDownIcon, CloudArrowUpIcon, HomeIcon, InboxArrowDownIcon, KeyIcon, PuzzlePieceIcon, ShoppingCartIcon, TicketIcon, UserCircleIcon, UserGroupIcon, UserIcon } from '@heroicons/react/24/outline'
...
export default function LayoutSidebarSection() {
  ...
  return (
    <>
      <div className="h-screen sticky top-0 flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
