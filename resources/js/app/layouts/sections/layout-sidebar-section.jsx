...
import { BriefcaseIcon, ClipboardDocumentIcon, CloudArrowUpIcon, HomeIcon, InboxArrowDownIcon, KeyIcon, PuzzlePieceIcon, ShoppingCartIcon, TicketIcon, UserGroupIcon, UserIcon } from '@heroicons/react/24/outline'
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-gray-50 text-gray-800">
        <div className="sticky top-0 flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
