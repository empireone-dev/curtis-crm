...
export default function ASCLayoutSubSidebarSection() {
        ...
        <div>
            <div className="flex flex-col flex-shrink-0 h-full px-2 py-4 border-r  bg-slate-200">
                ...
                <div className="flex flex-col items-center justify-center flex-1 space-y-4">
                    ...
                    <Link href='/asc/settings' className={`p-2 text-blue-400 transition-colors duration-200 rounded-full bg-blue-50 ${path == 'settings' ? 'bg-blue-500 text-white' : 'hover:bg-blue-100 hover:text-blue-600'}  focus:outline-none focus:bg-blue-100 focus:ring-blue-800`}>
