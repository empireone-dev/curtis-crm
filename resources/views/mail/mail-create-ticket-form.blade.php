                    ...
                    <div class="mt-6 border-t border-gray-100">
                        <dl class="divide-y divide-gray-100">
                            ...
                            <div class="px-4 py-2 sm:grid sm:grid-cols-4 sm:gap-4 sm:px-0">
                                ...
                                <a target="_blank" href="https://curtis-staging.cloud/customer/ticket-activity/{{ $data['id'] }}" class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">https://curtis-staging.cloud/customer/ticket-activity/{{ $data['id'] }}</a>
                            </div>
